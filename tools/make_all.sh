...
make LINUX_SRC="$LINUX_SRC_ROOT/linux-3.10.x-bromolow-25426" -j
...
make LINUX_SRC="$LINUX_SRC_ROOT/bromolow-DSM-7.0-toolkit/build" -j
...
make LINUX_SRC="$LINUX_SRC_ROOT/linux-4.4.x-apollolake-25426" -j
...
make LINUX_SRC="$LINUX_SRC_ROOT/apollolake-DS-7.0-toolkit/build" -j
